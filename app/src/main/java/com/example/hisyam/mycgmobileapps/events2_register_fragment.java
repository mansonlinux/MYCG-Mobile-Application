...
public class events2_register_fragment extends Fragment {
    View view;


    public events2_register_fragment() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.events2_register_fragment,container,false);
